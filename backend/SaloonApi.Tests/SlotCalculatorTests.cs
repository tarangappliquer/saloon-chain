...
public class SlotCalculatorTests
{
    ...
    public void LastSlotThatExactlyFitsBeforeClosingIsIncluded()
    {
        ...
        // 6 slots = 30 min, window is exactly 60 min -> last valid start is 09:30
        var slots = SlotCalculator.ComputeAvailableSlots(Date, TimeSpan.FromHours(9), TimeSpan.FromHours(18), totalDurationSlots: 6, pairs, []);
    ...
    public void DurationLongerThanShiftWindowProducesNoSlots()
    {
        ...
        var slots = SlotCalculator.ComputeAvailableSlots(Date, TimeSpan.FromHours(9), TimeSpan.FromHours(18), totalDurationSlots: 6, pairs, []); // needs 30 min
    ...
    public void MultiTreatmentDurationSumsBeforeComputingSlots()
    {
        ...
        // two treatments totalling 6 slots (30 min) should fit exactly once, at 09:00
        var slots = SlotCalculator.ComputeAvailableSlots(Date, TimeSpan.FromHours(9), TimeSpan.FromHours(18), totalDurationSlots: 6, pairs, []);
