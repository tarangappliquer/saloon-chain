...
public class PaymentWebhookTests
{
    ...
    {
        var options = TestOptionsMonitor.Create(new StripeOptions { WebhookSecret = "" });
        var portalOptions = TestOptionsMonitor.Create(new SaloonApi.Shared.Auth.PortalUrlOptions());
