  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        subtitle={`Fresha Partner Dashboard • Overview of today's salon performance, appointments, and shortcuts.`}
      ...
      <div className="grid gap-6 md:grid-cols-3">
        <Card hoverable className="p-6 md:col-span-2 space-y-4">
          <div className="flex items-center justify-between border-b border-border pb-4">
            <div>
              <h3 className="font-display text-lg font-bold text-foreground">Fresha Calendar Diary</h3>
