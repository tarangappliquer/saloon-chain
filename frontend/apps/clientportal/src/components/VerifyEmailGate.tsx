...
export function VerifyEmailGate() {
  ...
  return (
    <main className="min-h-[calc(100vh-5rem)] flex items-center justify-center p-4 sm:p-6">
      <Card className="w-full max-w-md space-y-4 p-6 sm:p-8 text-center shadow-lift border-border bg-card/95 backdrop-blur-md rounded-3xl">
        <div className="flex flex-col items-center">
          <BrandMark label="Shoppey Saloon" subtitle="Verify your email" />
        </div>
