...
**breakStartTime** | **string** |  | [default to undefined]
**breakEndTime** | **string** |  | [default to undefined]
**workingDaysMask** | **number** |  | [default to undefined]
...
```typescript
import { AdminLocationDto } from './api';

const instance: AdminLocationDto = {
    id,
    chainId,
    name,
    address,
